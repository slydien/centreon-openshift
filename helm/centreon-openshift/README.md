...
| global.securityContext.runAsNonRoot | bool | `true` | Run containers as non-root |
| global.securityContext.allowPrivilegeEscalation | bool | `false` | Allow privilege escalation |
| global.securityContext.capabilities.drop | list | `["ALL"]` | Linux capabilities to drop |
| global.securityContext.seccompProfile.type | string | "RuntimeDefault" | Seccomp profile type |
...
| services.web.ports[0].port | int | `8080` | Service port |
...
| services.web.probes.startup.httpGet.path | string | "/centreon/api/latest/platform/versions" | Startup probe HTTP path |
| services.web.probes.startup.httpGet.port | int | `8080` | Startup probe HTTP port |
...
| services.web.probes.readiness.httpGet.path | string | "/centreon/api/latest/platform/versions" | Readiness probe HTTP path |
| services.web.probes.readiness.httpGet.port | int | `8080` | Readiness probe HTTP port |
...
| services.web.probes.liveness.httpGet.path | string | "/centreon/api/latest/platform/versions" | Liveness probe HTTP path |
| services.web.probes.liveness.httpGet.port | int | `8080` | Liveness probe HTTP port |
